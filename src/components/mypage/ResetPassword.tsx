...
/**
 * @description 비밀번호 재발급 페이지 Api연동 미실시
 */
            ...
            <ResetPwWrap>
                <div>
                    ...
                    <TextWrap>
                        ...
                        <p>비밀번호 재발급을 위해서는 Api연동이 필요합니다.</p>
                    </TextWrap>
                    <form>
                        <InputWrap>
                            <label htmlFor="userId">아이디</label>
                            <input type="text" id="userId" name="userId" placeholder="Api연동이 필요합니다."/>
                        </InputWrap>
                        <InputWrap>
